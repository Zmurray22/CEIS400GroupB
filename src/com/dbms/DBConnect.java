...
{
    private Connection Conn; // This will be our class variable to store the database conneciton
    
    public DBConnect() {
        //try to connect to the database
        Conn = null; // We'll first set the connection to null so we can verify it's conenction later
        try {
            //drivermanager
